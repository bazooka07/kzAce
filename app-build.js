...
require.config({
	paths: {
		ace: PARAMS.ace,
		'ace/ext/emmet': PARAMS.ace + '/ext-emmet',
		'ace/ext/statusbar': PARAMS.ace + '/ext-statusbar'
	},
	shim: {
		'ace/ext/emmet': {
			deps: ['https://cloud9ide.github.io/emmet-core/emmet.js']
		}
	}
});
...
define(
	PARAMS.pluginName,
	['ace/ace', 'ace/ext/emmet', 'ace/ext/statusbar'], /* 'ace/ext/emmet', */
	function(ace, emmet) {
		...
		function myShowKeyboardShortcuts(editor) {
			...
			if(container == null) {
				...
				require(
					...
					function(getEditorKeybordShortcuts) {
						keybindings = getEditorKeybordShortcuts();
						var items = [];
